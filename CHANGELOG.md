...
- temporary removed Curios support until it is ported to 26.2 (NeoForge)
- temporary removed Trinkets Updated support until it is ported to 26.2 (Fabric/Quilt, NeoForge)
- temporary removed Accessories support until it is ported to 26.2 (Fabric/Quilt, NeoForge)

## [26.1.2-7.1.1.0] - 2026-06-07
### Added
- re-added Trinkets (Updated) support (NeoForge & Fabric/Quilt)
...
- temporary removed Accessories support until it is ported to 1.21.11 (Fabric/Quilt, NeoForge)
...
- temporary removed Accessories support until it is ported to 1.21.10 (Fabric/Quilt, NeoForge)
...
## [1.21.5-6.8.0.1] - 2025-05-10
- Updated Forge to 55.0.11 to fix startup issue

## [1.21.5-6.8.0.0] - 2025-04-25
### Changed
...
- Updated Accessories support (1.2.19-beta) (Fabric/Quilt, NeoForge)
