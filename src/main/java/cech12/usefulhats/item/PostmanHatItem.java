...
public class PostmanHatItem extends AbstractHatItem implements IEquipmentChangeListener, IUsefulHatModelOwner {
    ...
    public void onArmorTick(ItemStack stack, Level level, Player player) {
        if (!level.isClientSide) {
            ...
            int speedAmplifier = EnchantmentHelper.getTagEnchantmentLevel(Enchantments.BLOCK_EFFICIENCY, stack);
    ...
    public void onUnequippedHatItem(LivingEntity entity, ItemStack oldStack) {
        ...
        int speedAmplifier = EnchantmentHelper.getTagEnchantmentLevel(Enchantments.BLOCK_EFFICIENCY, oldStack);
