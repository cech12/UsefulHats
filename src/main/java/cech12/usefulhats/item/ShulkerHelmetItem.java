...
public class ShulkerHelmetItem extends AbstractHatItem implements IEquipmentChangeListener {
    ...
    public void onArmorTick(ItemStack stack, Level level, Player player) {
        if (!level.isClientSide) {
            ...
            int levitationAmplifier = EnchantmentHelper.getTagEnchantmentLevel(Enchantments.BLOCK_EFFICIENCY, stack);
    ...
    public void onUnequippedHatItem(LivingEntity entity, ItemStack oldStack) {
        ...
        int levitationAmplifier = EnchantmentHelper.getTagEnchantmentLevel(Enchantments.BLOCK_EFFICIENCY, oldStack);
