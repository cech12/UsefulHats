...
public class NeoForgeConfigHelper implements IConfigHelper {
    ...
    private int getInteger(ModConfigSpec.IntValue config, int defaultValue) {
        try {
            return config.get();
        } catch (IllegalStateException ex) {
            return defaultValue;
    ...
    private int getEnchantmentInteger(int enchantmentLevel, ModConfigSpec.IntValue config0, int defaultValue0, ModConfigSpec.IntValue config1, int defaultValue1, ModConfigSpec.IntValue config2, int defaultValue2, ModConfigSpec.IntValue config3, int defaultValue3, ModConfigSpec.IntValue config4, int defaultValue4, ModConfigSpec.IntValue config5, int defaultValue5) {
    ...
    private double getDouble(ModConfigSpec.DoubleValue config, double defaultValue) {
        try {
            return config.get();
        } catch (IllegalStateException ex) {
            return defaultValue;
    ...
    private double getEnchantmentDouble(int enchantmentLevel, ModConfigSpec.DoubleValue config0, double defaultValue0, ModConfigSpec.DoubleValue config1, double defaultValue1, ModConfigSpec.DoubleValue config2, double defaultValue2, ModConfigSpec.DoubleValue config3, double defaultValue3, ModConfigSpec.DoubleValue config4, double defaultValue4, ModConfigSpec.DoubleValue config5, double defaultValue5) {
        if (enchantmentLevel < 0) {
